// MAIN POUR TESTER LA FONCTION estSousGrapheDesert
...
int main(int argc, const char * argv[])
{
    ...
    estDesert = estSousGraphDesert(tailleG, graphe, tailleEnsemble, s);

    if (estDesert == 0) printf("est desert : OUI\n");
    else printf("est desert : NON\n");
